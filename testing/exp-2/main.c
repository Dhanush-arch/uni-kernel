 ...
 * since it happens inside a child process, it overwrites the value in the child 
 * process stack and not in the parent process stack.
 * This shows that values in the parent process stack are unaffected.
 * The buffer overflow is handled by process.
**/
...
void serve(int sock, struct sockaddr *addr, char *password, char *input) {
    strcpy(input, "");
...
//        printf("Pret: %d \n", pret);
    ...
    if(strcmp(method, "POST") == 0) {
        //body_len = phr_decode_chunked((const char *) &buf[prevbuflen], rret, (char *) &body);
        buf[buflenout] = '\0';
        printf("POST body: - %s - \n", buf);
    } else {
        struct stat st;
...
int main(int argc, char **argv) {
    ...
    int opt;
    char inputpassword[50] = "default";
    char password[50] = "password";
    char *www_dir = "/nonexistent";

    printf("\nExp 2 where buffer overflow is prevented using processes\n\n");
    ...
    while (true) {
        ...
        if (ret < 0) {
            ...
            strcpy(inputpassword, "ddddddddd");
            printf("inside the child process:\nstored password: %s\n inputpassword: %s\n", password, inputpassword);
            serve(client_sock, &client_addr, password, inputpassword);
            exit(0);
        } 
