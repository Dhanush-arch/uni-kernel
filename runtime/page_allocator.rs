...
use unikernel_utils::alignment::is_aligned;
use unikernel_utils::byte_size::ByteSize;

use unikernel_utils::bitmap_allocator::BitMapAllocator as Allocator;

// TODO: Fix bugs in use the buddy allocator.
// use unikernel_utils::buddy_allocator::BuddyAllocator as Allocator;

// Comment out the following line to use BumpAllocator.
// use unikernel_utils::bump_allocator::BumpAllocator as Allocator;
