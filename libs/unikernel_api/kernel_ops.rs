//! Internal APIs exposed for unikernel_kernel crate. **Don't use from your kernel extensions!**
use alloc::boxed::Box;
use unikernel_runtime::bootinfo::{AllowedPciDevice, VirtioMmioDevice};
use unikernel_utils::static_cell::StaticCell;
